...
enemy1 = Enemy(100, 100, 0, 150)
enemy2 = Enemy(700, 150, 1, 150)
enemy3 = Enemy(1000, 350, 0, 100)
enemy4 = Enemy(150, 600, 1, 150)
...
while run:
    ...
    for bullet in enemy_bullets:
        if abs(bullet.x - (player.rect.center[0])) <= 100 and abs(bullet.y - (player.rect.center[1])) <= 100:
            color = (255, 0, 0)
